          ...
          <div className="rounded-[28px] border border-border bg-card">
            <div className="relative overflow-hidden px-8 py-16 text-center md:px-16">
              <h2 className="text-3xl sm:text-4xl font-bold tracking-tight text-foreground">
                Put the Unity Editor <br />
                <span className="text-primary">on the command line</span>
              </h2>
              <p className="mt-4 text-lg text-muted-foreground">
                Install the CLI, add the bridge, and script scenes, play mode, tests, and builds. Open source, MIT
                licensed.
              </p>
